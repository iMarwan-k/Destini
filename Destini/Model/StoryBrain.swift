...
//    let example = [
//        Story("You see a fork in the road.", "Take a left.", "Take the right."),
//        Story("You see a tiger", "Shout for help.", "play dead"),
//        Story("You find a treasure chest", "Open it.", "Check for taps.")
//    ]
    ...
    mutating func nextStory(_ userChoice: String) {
        if userChoice == stories[storyNum].choice1 {
            storyNum = stories[storyNum].c1Destination
        } else {
            storyNum = stories[storyNum].c2Destination
        }
    }
}
